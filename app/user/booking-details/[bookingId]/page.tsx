...
const CountdownTimer: React.FC<CountdownTimerProps> = ({ 
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      const targetTime = new Date(estimatedArrivalTime).getTime();
  ...
  }, [estimatedArrivalTime, bookingId, departureStation, destinationStation, notificationsSent]);
...
const UrgencyMessage: React.FC<UrgencyMessageProps> = ({ estimatedArrivalTime }) => {
                    ...
                    <div className="bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-2xl p-6 sm:p-8 border border-red-500/30 shadow-lg shadow-red-500/20">
                      <div className="text-center">
                        ...
                        <div className="mt-4 text-sm text-gray-400 font-mono">
                          <p>ESTIMATED_DEPARTURE: {formatDate(booking.estimatedArrivalTime)}</p>
                          <p className="text-red-400 font-medium">ARRIVE_15_MINUTES_EARLY</p>
                        </div>
                        
                        {/* Urgency Messages */}
                        <UrgencyMessage estimatedArrivalTime={booking.estimatedArrivalTime} />
                      </div>
                    </div>
                  </div>
                )}
