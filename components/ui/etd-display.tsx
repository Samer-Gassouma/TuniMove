  ...
  if (compact) {
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        ...
        <Badge className={`px-2 py-0.5 text-xs ${getConfidenceColor(etaPrediction.confidenceLevel)}`}>
          {confidencePercent}%
        </Badge>
      </div>
    )
    ...
    <div className={`bg-slate-800/30 rounded-xl border border-slate-600/30 p-4 ${className}`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="text-center">
          <div className="text-2xl font-bold text-cyan-400">{etaPrediction.etdHours}h</div>
      ...
      {showDetails && (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Badge className={`px-2 py-1 ${getConfidenceColor(etaPrediction.confidenceLevel)}`}>
